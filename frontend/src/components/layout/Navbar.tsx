...
import { ShoppingCart, User, LogOut, Package, Search, MapPin, ChevronDown, Zap } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center gap-4 h-16">
          ...
          <Link to="/" className="flex items-center gap-2 shrink-0">
            ...
            <span className="text-xl font-extrabold text-gray-900 tracking-tight hidden sm:block">ShopHub</span>
          </Link>

          {/* Delivery / location chip */}
          <div className="hidden lg:flex flex-col leading-tight pl-2 border-l border-gray-100">
            <span className="text-[13px] font-bold text-gray-900">Delivery in 10 minutes</span>
