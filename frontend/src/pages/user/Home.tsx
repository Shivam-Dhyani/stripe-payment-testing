  ...
  return (
    <div>
      ...
      <section className="bg-gradient-to-r from-brand-600 to-brand-800 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
          <div className="max-w-2xl">
            ...
            <Link
              to="/products"
              className="inline-flex items-center px-6 py-3 bg-white text-brand-600 rounded-lg font-semibold hover:bg-brand-50 transition"
            >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500">Curated selections</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <section className="py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between mb-8">
            <h2 className="text-title-sm font-bold text-gray-800">Shop by Category</h2>
            <Link to="/products" className="text-brand-500 hover:text-brand-600 font-medium flex items-center">
      ...
      <section className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between mb-8">
            <h2 className="text-title-sm font-bold text-gray-800">Trending Products</h2>
            <Link to="/products" className="text-brand-500 hover:text-brand-600 font-medium flex items-center">
              View All <ArrowRight className="ml-1 w-4 h-4" />
            </Link>
          </div>
      ...
      <section className="py-16 bg-brand-500">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-title-sm font-bold text-white mb-4">Ready to Start Shopping?</h2>
          <p className="text-brand-100 mb-8 text-lg">Create an account and get exclusive deals.</p>
          <Link
            to="/register"
            className="inline-flex items-center px-6 py-3 bg-white text-brand-600 rounded-lg font-semibold hover:bg-brand-50 transition"
          >
