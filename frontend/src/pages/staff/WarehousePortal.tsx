...
import { Package, ClipboardList, CheckCircle, Truck, RefreshCw, Boxes } from 'lucide-react';
        ...
        <div className="flex items-center justify-between mb-6">
          <div>
            ...
            <p className="text-sm text-gray-500 mt-1">
              {counts.active} to prepare &middot; {counts.packed} packed &amp; awaiting dispatch
            </p>
          </div>
          <button
            onClick={load}
